...
export interface Floor {
  ...
  hazards?: { x: number; y: number; kind: "fire" | "venom" | "crumble" | "miasma"; cracked?: number }[]; // 地形ハザード（v0.128.0）：web が enterFloor 初訪で seeded 配置＝engine 非使用＝golden 安全（aurelSite と同じパターン）。cracked＝崩れかけの床の崩落カウントダウン。
