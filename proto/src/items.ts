...
const TEMPLATES: Template[] = [
  ...
  { slot: "weapon", name: "天照の大御槍", minDepth: 20, dmg: 5, reach: 2, proc: "cleave", exclusive: true }, // 伝説槍＝主神の威光（攻5＝全武器最高の別格）・光の薙ぎ＋reach2＝v0.131.0で浄性(-0.02)を撤去（欠点ゼロの是正・最強キットではあるが浄化なし）
