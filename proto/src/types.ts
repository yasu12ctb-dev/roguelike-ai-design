...
export interface World {
  ...
  aurelChapter?: number;        // メインの縦糸「アウレルの遺した問い」の章（0..6・World蓄積＝世代越え・4-15）。答えは出さない謎の背骨。任意＝旧セーブ非破壊。
...
export interface Item {
  ...
  sweep?: boolean;          // 武器：薙刀＝距離2の横3マスバー（v0.150.0＝十字4方向・中央100%/肩80%・隣接は死角＝斬れない・踏み込み不可・会心で押し出し+stagger）。基テンプレ由来＝銘/+N と独立
