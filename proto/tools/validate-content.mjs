...
const CONTEXTS = new Set(["encounter", "dungeon", "street", "tavern", "guild", "shop", "quest", "chest", "delver", "noble"]);
const TOWN = new Set(["street", "tavern", "guild", "shop", "quest", "noble"]);
...
for (const c of ["tavern", "guild", "shop", "quest", "delver", "noble"]) SLOTS[c] = SLOTS.street;
